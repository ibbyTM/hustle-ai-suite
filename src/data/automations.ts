...
export const automations: AutomationTool[] = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { id: "targetMetric", label: "Target (e.g., $500/week, 1000 followers, master React)", type: "text", placeholder: "Your specific measurable goal" },
    ...
    promptTemplate: "Here's a personalized 3-task plan for daily growth toward achieving {targetMetric} in your {goal} goal, tailored to the {industry} niche and difficulty level: {difficulty}. Each task is concise, actionable, and designed for measurable progress.\n\nFor each of the 3 tasks, use this exact structure:\n\n**Task #[number] – [Task Headline]**\n\n**Objective:**\nWrite 1-2 lines explaining what success looks like for this task and how it contributes to reaching {targetMetric}.\n\n**Steps:**\nProvide 2-3 actionable bullet points that break down how to complete the task.\n\n**Time Required:**\nGive a rough time estimate (e.g., 15 mins, 1 hour, 30 mins).\n\n**Progress Metric:**\nDefine how to measure if this task moved you closer to {targetMetric}.\n\nAfter all 3 tasks, include:\n\n**Daily Motivation Quote:**\nProvide 1 short motivational quote relevant to achieving {targetMetric}.\n\n**Reflection Prompt:**\nWrite 1 short self-question for accountability focused on progress toward {targetMetric} (e.g., 'What's one thing I did today that moved me closer to my goal?').\n\nDo not use emojis or slang like 'Yo,' 'stackin',' 'let's get it,' etc. Use short, precise sentences—sound like a focused productivity coach. Keep formatting clean with clear headers and bullet lists."
  },
  {
